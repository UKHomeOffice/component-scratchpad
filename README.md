...
| input box     | input\|Label here:Hint text here                                                                               | Hint text is optional, defined after a colon (:)                                                                         |
| Textarea box  | textarea\|Label here:Hint text here                                                                            | Hint text is optional, defined after a colon (:)                                                                         |
| date input    | date\|Label here                                                                                               |                                                                                                                          |
| radio buttons | radios\|Label here:Hint text here\|Radio 1\|Radio 2\|...final radio                                            | Hint text is optional, defined after a colon (:)                                                                         |
| checkboxes    | checkboxes\|Label here:Hint text here\|checkbox 1\|checkbox 2\|...final checkbox                                              | Hint text is optional, defined after a colon (:)                                                                                                                               |
| select        | select\|Label here:Hint text here\|option 1\|option 2\|...final option<br>                                                    | Hint text is optional, defined after a colon (:)                                                                                                                              |
